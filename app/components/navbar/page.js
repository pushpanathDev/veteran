...
import { useAuth } from "@/app/context/AuthContext"; // Make sure your useAuth hook works!
...
const Navbar = () => {
  ...
  const handleSignOut = async () => {
    await signOut(auth);
    // Firebase AuthContext should handle clearing user & show login popup automatically
  };
...
{user && (
  <div className="relative">
    ...
    {profileOpen && (
      <div
        className="absolute right-0 mt-3 w-64 rounded-xl shadow-2xl border border-gray-200 overflow-hidden
        bg-gradient-to-br from-white via-blue-50 to-blue-100 backdrop-blur-xl
        animate-fadeIn"
      >
        {/* Profile Info */}
